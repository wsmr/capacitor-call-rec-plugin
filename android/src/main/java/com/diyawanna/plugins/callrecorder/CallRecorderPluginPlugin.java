...
// @CapacitorPlugin(name = "CallRecorderPlugin")
// public class CallRecorderPluginPlugin extends Plugin {
//
//     private CallRecorderPlugin implementation = new CallRecorderPlugin();
//
//     @PluginMethod
...
public class CallRecorderPluginPlugin extends Plugin {
    ...
    private static final String TAG = "CallRecorderPluginPlugin";
